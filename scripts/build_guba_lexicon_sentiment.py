...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/build_guba_lexicon_sentiment.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/build_guba_lexicon_sentiment.py --stocks 000001,600519
  PYTHONPATH=. ./.venv/Scripts/python scripts/build_guba_lexicon_sentiment.py --shard 0/8
"""
import argparse
import logging
import os
