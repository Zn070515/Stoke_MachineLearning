...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/current/refetch_guba_bodies.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/current/refetch_guba_bodies.py --min-coverage 0.5
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/current/refetch_guba_bodies.py --stocks 000001,600519
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/current/refetch_guba_bodies.py --workers 8
"""
import argparse
import logging
import os
