...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_consolidate_fund_flat.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_consolidate_fund_flat.py --shard 0/8
"""
import argparse
import glob
import logging
