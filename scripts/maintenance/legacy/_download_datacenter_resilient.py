...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_download_datacenter_resilient.py --type block_trade
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_download_datacenter_resilient.py --type lockup --batch 200
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_download_datacenter_resilient.py --type block_trade --stocks 000001,600519
"""
import argparse
import logging
import os
