...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_rebuild_news_silver.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_rebuild_news_silver.py --shard 0/4
"""
import argparse
import glob
import logging
