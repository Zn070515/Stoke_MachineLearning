...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_download_valuation_em.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_download_valuation_em.py --stocks 600519,000001
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_download_valuation_em.py --start 2015-01-01
