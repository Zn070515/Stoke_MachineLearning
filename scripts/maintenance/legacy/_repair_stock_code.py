...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_repair_stock_code.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_repair_stock_code.py --types margin,capital_flow
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_repair_stock_code.py --dry-run
"""
import argparse
import glob
import logging
