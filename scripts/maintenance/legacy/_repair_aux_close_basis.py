...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_repair_aux_close_basis.py --dry-run
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_repair_aux_close_basis.py --codes 000001
  PYTHONPATH=. ./.venv/Scripts/python scripts/maintenance/legacy/_repair_aux_close_basis.py --shard 0/4
"""
import argparse
import glob
import logging
