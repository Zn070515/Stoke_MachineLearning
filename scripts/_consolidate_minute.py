...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_consolidate_minute.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/_consolidate_minute.py --freq 60
  PYTHONPATH=. ./.venv/Scripts/python scripts/_consolidate_minute.py --dry-run
"""
import argparse
import logging
import sys
