...
Usage:
  ...
  PYTHONPATH=. ./.venv/Scripts/python scripts/download_earnings.py
  # full historical backfill
  PYTHONPATH=. ./.venv/Scripts/python scripts/download_earnings.py --start-year 2020
  # explicit period list
  PYTHONPATH=. ./.venv/Scripts/python scripts/download_earnings.py --report-dates 20260331,20251231
"""
import argparse
import logging
import os
