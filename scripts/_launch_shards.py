...
Launcher args go BEFORE the script name:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_launch_shards.py --shards 4 download_fundamentals.py --sleep 0 --start 2015-01-01
  PYTHONPATH=. ./.venv/Scripts/python scripts/_launch_shards.py --shards 4 download_comment.py --history --sleep 0
  PYTHONPATH=. ./.venv/Scripts/python scripts/_launch_shards.py --shards 4 download_news.py --max-pages 20 --sleep 0 --skip-sentiment
  PYTHONPATH=. ./.venv/Scripts/python scripts/_launch_shards.py --shards 4 download_guba.py --sort comment --page-delay 0.1 --max-pages 500 --sleep 0 --skip-sentiment --no-bodies
"""
import argparse
import os
import subprocess
