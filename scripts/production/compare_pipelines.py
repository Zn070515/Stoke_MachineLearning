...
Usage:
    PYTHONPATH=. ./.venv/Scripts/python scripts/production/compare_pipelines.py --stocks 3
    PYTHONPATH=. ./.venv/Scripts/python scripts/production/compare_pipelines.py --stocks 3 --train
"""
