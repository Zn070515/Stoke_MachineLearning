...
Usage:
  python scripts/production/download_market_data.py --type all
  python scripts/production/download_market_data.py --type margin --start 2020-01-01
  python scripts/production/download_market_data.py --type northbound --stocks 600519
  python scripts/production/download_market_data.py --type all --concurrent
"""
import argparse
import logging
import os
