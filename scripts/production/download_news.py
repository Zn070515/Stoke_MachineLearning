...
Usage:
  python scripts/production/download_news.py                              # all stocks, all sources
  python scripts/production/download_news.py --stocks 000001,600519       # specific stocks
  python scripts/production/download_news.py --source sina                # single source
  python scripts/production/download_news.py --source ths,sina       # selected sources
  python scripts/production/download_news.py --max-pages 5 --sleep 1      # deeper, faster
  python scripts/production/download_news.py --concurrent                 # parallel download
  python scripts/production/download_news.py --skip-sentiment             # raw only
"""
import argparse
import logging
import os
