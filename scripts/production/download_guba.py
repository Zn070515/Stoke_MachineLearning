...
Usage:
  python scripts/production/download_guba.py                              # all stocks
  python scripts/production/download_guba.py --stocks 000001,600519       # specific stocks
  python scripts/production/download_guba.py --max-pages 5 --sleep 1      # deeper, faster
  python scripts/production/download_guba.py --concurrent                 # parallel download
  python scripts/production/download_guba.py --skip-sentiment             # raw + PIT only
"""
import argparse
import logging
import os
