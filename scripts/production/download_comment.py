...
Usage:
  python scripts/production/download_comment.py                     # snapshot only
  python scripts/production/download_comment.py --history           # snapshot + per-stock 30d
  python scripts/production/download_comment.py --stocks 600519     # specific stocks
"""
import argparse
import logging
import os
