...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/production/download_minute.py --frequency 60 --stocks 100
  PYTHONPATH=. ./.venv/Scripts/python scripts/production/download_minute.py --frequency 30 --all
  PYTHONPATH=. ./.venv/Scripts/python scripts/production/download_minute.py --frequency 60 --stock-list 600519,000001
