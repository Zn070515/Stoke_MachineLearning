...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python -u scripts/production/download_valuation.py
  PYTHONPATH=. ./.venv/Scripts/python -u scripts/production/download_valuation.py --stocks 600519,000001
  PYTHONPATH=. ./.venv/Scripts/python -u scripts/production/download_valuation.py --start 2010-01-01
"""
import argparse
import os
import sys
