...
Usage:
  python scripts/production/download_fundamentals.py
  python scripts/production/download_fundamentals.py --stocks 000001,600519
  python scripts/production/download_fundamentals.py --start 2020-01-01 --end 2024-12-31 --sleep 0.5
"""
import argparse
import logging
import os
