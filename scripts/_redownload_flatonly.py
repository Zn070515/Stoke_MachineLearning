...
Identified by scripts/_probe_flatonly_seams.py (sawtooth > 0 = opposite-sign
...
pct_change are self-consistent. Atomic per-file replace.

Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_redownload_flatonly.py --limit 5
  PYTHONPATH=. ./.venv/Scripts/python scripts/_redownload_flatonly.py
"""
import argparse
import os
import time
