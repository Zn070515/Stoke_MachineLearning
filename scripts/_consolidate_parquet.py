...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_consolidate_parquet.py sentiment
  PYTHONPATH=. ./.venv/Scripts/python scripts/_consolidate_parquet.py fundamentals
  PYTHONPATH=. ./.venv/Scripts/python scripts/_consolidate_parquet.py all
"""
import logging
import os
import shutil
