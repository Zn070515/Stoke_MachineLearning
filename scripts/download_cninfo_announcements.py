...
Usage:
  python scripts/download_cninfo_announcements.py                             # all stocks, EastMoney
  python scripts/download_cninfo_announcements.py --source cninfo             # CNINFO (PDF bodies)
  python scripts/download_cninfo_announcements.py --shard 0/4                 # 1/4 of stocks
  python scripts/download_cninfo_announcements.py --stocks 000001,600519      # specific stocks
  python scripts/download_cninfo_announcements.py --skip-sentiment            # raw only
"""
import argparse
import logging
import os
