...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_merge_turnover.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/_merge_turnover.py --stocks 000001,600519
"""
import argparse
import logging
import os
...
def main():
    ...
    for i, code in enumerate(todo):
        ...
        try:
            ...
            daily.to_parquet(daily_path, index=False, compression='lz4')
