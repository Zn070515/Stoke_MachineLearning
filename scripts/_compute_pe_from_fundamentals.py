...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_compute_pe_from_fundamentals.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/_compute_pe_from_fundamentals.py --stocks 600519,000001
