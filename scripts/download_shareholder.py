...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/download_shareholder.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/download_shareholder.py --start 2015-01-01
  PYTHONPATH=. ./.venv/Scripts/python scripts/download_shareholder.py --date 2023-09-30
"""
import argparse
import logging
import sys
