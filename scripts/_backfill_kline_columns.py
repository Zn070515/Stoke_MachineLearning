...
Usage:
  PYTHONPATH=. ./.venv/Scripts/python scripts/_backfill_kline_columns.py
  PYTHONPATH=. ./.venv/Scripts/python scripts/_backfill_kline_columns.py --stocks 000001,600519
"""
import argparse
import logging
import sys
...
def main():
    ...
    for i, (code, missing) in enumerate(todo):
        ...
        try:
            ...
            merged.to_parquet(data_dir / f"{code}.parquet", index=False, compression='lz4')
